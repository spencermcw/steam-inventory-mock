 ...
 * dist/itemdefs.json that is not a scalar is a delimited string, and this file
 * is the only place that knows how to take those strings apart.
 *
 * Grammars implemented (see ../../SteamAPIDocs.md):
 *
 ...
 * offending source string, because a parse failure here means the transpiler
 * emitted something Steam would have rejected.
 */
 ...
 * operand is identified by the presence of ":" — matching how the transpiler
 * decides to pass an operand through verbatim (transpile.js:parseMaterial).
 */
