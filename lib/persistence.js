...
/**
 * version N → N+1 upgrades, applied in sequence on load.
 * e.g. `1: state => ({ ...state, version: 2, account: addField(state.account) })`
 */
const MIGRATIONS = {};
...
module.exports = { saveState, loadState, writeSave, readSave, migrate, SAVE_VERSION, SAVE_KIND };
